...
public class SoundLibraryEditor : Editor
{
    ...
    private void GenerateEnumAndLookup(SoundLibrary bank)
    {
        ...
        string enumPath = Path.Combine(parent, "SoundName.cs");
        string lookupPath = Path.Combine(parent, "SoundLookup_Generated.cs");

        var enumBuilder = new StringBuilder();
        var lookupBuilder = new StringBuilder();

        enumBuilder.AppendLine("// Auto-generated by SoundBankEditor. Do not modify manually.");
        enumBuilder.AppendLine("public enum SoundName");
        ...
        lookupBuilder.AppendLine("public static class SoundLookup_Generated");
        lookupBuilder.AppendLine("{");
        lookupBuilder.AppendLine("    public static readonly Dictionary<SoundName, string> IdToGuid = new()");
        lookupBuilder.AppendLine("    {");
        ...
        foreach (var entry in bank.Sounds) {
            ...
            lookupBuilder.AppendLine($"        {{ SoundName.{safeName}, \"{entry.guid}\" }},");
        }
